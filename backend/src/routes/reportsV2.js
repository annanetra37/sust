      ...
      if (disc.type === 'metric' && discData?.hasData) {
        if (topicKey === 'E1' && data.E1) {
          ...
          if (disc.code === 'GRI 305-1') {
            ...
            if (Object.keys(s1Cats).length > 0) {
              children.push(text('Scope 1 by activity category:', { bold: true }));
              Object.entries(s1Cats)
                .sort((a, b) => b[1] - a[1])
                .forEach(([label, value]) => children.push(bullet(`${label}: ${round(value)} tCO2e`)));
            }
            ...
            if (Object.keys(s2Cats).length > 0) {
              children.push(text('Scope 2 by energy carrier:', { bold: true }));
              Object.entries(s2Cats)
                .sort((a, b) => b[1] - a[1])
                .forEach(([label, value]) => children.push(bullet(`${label}: ${round(value)} tCO2e`)));
            }
            ...
            if (Object.keys(s3Cats).length > 0) {
              children.push(text('Scope 3 breakdown by category:', { bold: true }));
              Object.entries(s3Cats)
                .sort((a, b) => b[1] - a[1])
                .forEach(([label, value]) => children.push(bullet(`${label}: ${round(value)} tCO2e`)));
            }
            children.push(
